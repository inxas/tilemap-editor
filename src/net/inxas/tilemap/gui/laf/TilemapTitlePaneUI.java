...
import net.inxas.tilemap.gui.TilemapTitlePane;
 ...
 * @version 0.0-alpha
 */
public class TilemapTitlePaneUI extends ComponentUI {
    private static TilemapTitlePaneUI titlePaneUI;
    ...
    /**
     * 文字列を描画します。
     * もし文字列が長く、描画しきれない場合はフェードアウト効果をかけます。
     * @param g グラフィックス
     * @param t タイトルペイン
     */
